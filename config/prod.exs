...
config :backgammon_2, Backgammon2Web.Endpoint,
  ...
  password: get_secret.("backgammon_2") # Manually make file match password
...
#
#     config :backgammon, Backgammon2Web.Endpoint,
#       ...
...
# start per endpoint:
#
#     config :backgammon, Backgammon2Web.Endpoint, server: true
#
